...
namespace JobSearch2._0.Controllers
{
    public class JobsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Applied,Rejected,Interviewed,OfferRecieved,Accepted")] Job job)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Applied,Rejected,Interviewed,OfferRecieved,Accepted")] Job job)
        {
            if (id != job.Id)
            {
                return NotFound();
